 ...
 * 
 */
class Tags extends PdoObjectRecordAbstract  {

	/** Table name */
	protected string $tableName = "Tags";
	/** Primary key column name */
	protected ?string $primaryKeyColumnName = "TagId";
	/** Insertable column name */
	protected ?array $insertableColumnsName = [ "TagLabel", "TagDescriptionShort", "TagDescription", "TagIllustrationRelativePath" ];
	/** Updatable column name */
	protected ?array $updatableColumnsName = [ "TagLabel", "TagDescriptionShort", "TagDescription", "TagIllustrationRelativePath" ];
...
";
			...
			if ( $query ){
				...
				foreach ( $rows as $key => &$row){
					$row["IllustrationUrl"] = $config["rootUrl"] . "/info/img/" . $row["TagIllustrationRelativePath"];
				}
	...
	function fetch():?array {
		global $config;
		$data = parent::fetch();
		$data["IllustrationUrl"] = $config["rootUrl"] . "/info/img/" . $data["TagIllustrationRelativePath"];
		return $data;
	}
}
