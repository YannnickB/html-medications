...
class Medications extends PdoObjectRecordAbstract  {
	...
	protected ?array $insertableColumnsName = [ "MedicationLabel", "MedicationDescriptionShort", "MedicationDescription", "MedicationLogoRelativePath", "MedicationIsNaturalProduct", "MedicationIsVegetable" ];
	/** Updatable column name */
	protected ?array $updatableColumnsName = [ "MedicationLabel", "MedicationDescriptionShort", "MedicationDescription", "MedicationLogoRelativePath", "MedicationIsNaturalProduct", "MedicationIsVegetable" ];
